        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrackOrder_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackOrder_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOrderIngredient", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductOrderIngredient_Ingredient_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredient",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductOrderIngredient_ProductOrder_ProductOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOrderIngredient_IngredientId",
                table: "ProductOrderIngredient",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOrderIngredient_ProductOrderId",
                table: "ProductOrderIngredient",
